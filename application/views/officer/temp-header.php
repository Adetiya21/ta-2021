							...
							<li class="user-profile header-notification">
								<div class="dropdown-primary dropdown">
									<div class="dropdown-toggle" data-toggle="dropdown">
										...
										<?php } else { ?>
											<img src="<?= base_url('assets/img/officer/'.$this->session->userdata('gambar')) ?>" class="img-radius" alt="User-Profile-Image">
										<?php } ?>
						...
						<div class="nav-list">
							<div class="pcoded-inner-navbar main-menu">
								...
								<ul class="pcoded-item pcoded-left-item">								
									...
									<li class="supplier">
										<a href="<?= site_url('officer/supplier') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<li class="tagihan pcoded-hasmenu">
										...
										<ul class="pcoded-submenu">
											<?php if ($this->session->userdata('tipe')=='Finance') { ?>
												<li class="pcoded-hasmenu data-tagihan">
													<a href="javascript:void(0)" class="waves-effect waves-dark">
														<span class="pcoded-mtext">Data Tagihan</span>
													</a>
													<ul class="pcoded-submenu">
														<li class="tunggu-tagihan">
															<a href="<?= site_url('officer/tagihan') ?>" class="waves-effect waves-dark">
																<span class="pcoded-mtext">Status Menunggu</span>
															</a>
														</li>
														<li class="terima-tagihan">
															<a href="<?= site_url('officer/tagihan/terima') ?>" class="waves-effect waves-dark">
																<span class="pcoded-mtext">Status Diterima</span>
															</a>
														</li>
														<li class="seluruh-tagihan">
															<a href="<?= site_url('officer/tagihan/i') ?>" class="waves-effect waves-dark">
																<span class="pcoded-mtext">Seluruh Data</span>
															</a>
														</li>
													</ul>
												</li>
											...
											<?php } ?>
											<li class="pcoded-hasmenu laporan-tagihan">
												<a href="javascript:void(0)" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Laporan Tagihan</span>
												</a>
												<ul class="pcoded-submenu">
													<?php if ($this->session->userdata('tipe')=='Finance') { ?>
													<li class="laporan-diterima">
														<a href="<?= site_url('officer/tagihan/selesai/'.$this->session->userdata('tipe')) ?>" class="waves-effect waves-dark">
															<span class="pcoded-mtext">Selesai <?= $this->session->userdata('tipe'); ?></span>
														</a>
													</li>
													<?php } else { ?>
													<li class="laporan-diterima">
														<a href="<?= site_url('officer/tagihan/diterima/'.$this->session->userdata('tipe')) ?>" class="waves-effect waves-dark">
															<span class="pcoded-mtext">Diterima 
																<?= $this->session->userdata('tipe'); ?></span>
														</a>
													</li>
													<?php } ?>
													<li class="laporan-ditolak">
														<a href="<?= site_url('officer/tagihan/ditolak/'.$this->session->userdata('tipe')) ?>" class="waves-effect waves-dark">
															<span class="pcoded-mtext">Ditolak 
																<?= $this->session->userdata('tipe'); ?></span>
														</a>
													</li>
												</ul>
