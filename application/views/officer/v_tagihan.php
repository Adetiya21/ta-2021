...
<script>
    $(document).ready(function() {
        ...
        $('.tunggu-tagihan').addClass('active');
    });
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Data Tagihan</h5>
                        <span>Berikut data tagihan status menunggu ....</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>officer/tagihan/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status_fin" class="form-control" id="test">
                                <option>--- Pilih Status Tagihan ---</option>
                                <option value="Menunggu">Menunggu</option>
                                <option value="Diterimaa">Diterima</option>
...
<script type="text/javascript">
    document.getElementById('test').addEventListener('change', function () {
        var style = this.value == 'Diterimaa' ? 'block' : 'none';
