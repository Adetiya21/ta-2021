...
<script>
    $(document).ready(function() {
      ...
      $('.laporan-ditolak').addClass('active');
  	});
		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Laporan Tagihan <label class="label label-sm label-inverse" style="text-align:center">Ditolak</label></h5>
						<span>Berikut data laporan tagihan yang ditolak <?= $tipe ?>.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/tagihan/ditolak/'.$tipe) ?>">Laporan Ditolak</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="page-body">
					<div class="card">
						<div class="card-header">
							<h5>Laporan Data Tagihan Yang Ditolak <?= $tipe ?></h5>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>officer/tagihan/jsontolak", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
...
kendo.drawing
    ...
    { 
        ...
        .then(function(group){
        kendo.drawing.pdf.saveAs(group, "Laporan Tagihan Ditolak <?= $tagihan->nama; ?>.pdf")
    });
}
</script>