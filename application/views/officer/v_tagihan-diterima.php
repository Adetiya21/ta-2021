...
<script>
    $(document).ready(function() {
        ...
        $('.terima-tagihan').addClass('active');
    });
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Data Tagihan</h5>
                        <span>Berikut data tagihan status diterima ....</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?= site_url('officer/tagihan/terima') ?>">Tagihan</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>officer/tagihan/jsonDiterima", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
