				...
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						<li class="breadcrumb-item">
							<a href="<?= site_url('supplier/home') ?>"><i class="feather icon-home"></i></a>
						</li>
						<li class="breadcrumb-item">
							<a href="<?= site_url('supplier/home/profil') ?>">Profil</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-block">
									<!-- <form id="main" method="post" action="https://colorlib.com/" novalidate> -->
										...
										<?= form_open('home/edit_profil', $arb); ?>
										<div class="row">
											<div class="col-sm-4">
                          ...
                          <div class="form-group" id="photo">
                              <div>
                              <img id="uploadPreview" style="max-width:200px;" class="img-thumbnail" src="<?= base_url('assets/img/supplier/') ?><?= $profil->gambar ?>"/>
                              <span class="help-block"></span>
                              </div>
                          </div>											
												</div>
