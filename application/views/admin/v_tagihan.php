  ...
  <div class="pcoded-inner-content"  style="margin-top: -20px;margin-bottom: -20px">
    <div class="main-body">
      <div class="page-wrapper">
        <div class="page-body">
          <a href="<?= site_url('admin/tagihan/laporan') ?>" class="btn btn-danger btn-round" onclick="ExportPdf()"><span class="fa fa-file"></span> Laporan Tagihan</a>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/tagihan/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    	...
    	if(confirm('Anda yakin ingin menghapus data?'))
      	{
            ...
            $.ajax({
              url : '<?php echo site_url("admin/tagihan/hapus/'+id+'") ?>',
              type: "POST",
              dataType: "JSON",
