		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Laporan Tagihan Diterima</h5>
						<span>Berikut data laporan seluruh tagihan.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/tagihan/laporan/') ?>">Laporan Diterima</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/tagihan/jsonLaporan", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
        ...
        {"data": "status",
            render: function(data) { 
                if(data==='Menunggu Acc Loket') {
                  return '<label class="label label-sm label-primary" style="width:100%; text-align:center">'+data+'</label>' 
                }
...
kendo.drawing
    ...
    { 
        ...
        .then(function(group){
        kendo.drawing.pdf.saveAs(group, "Laporan Tagihan Diterima.pdf")
    });
}
</script>