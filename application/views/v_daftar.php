            ...
            <div class="auth-box row text-center">
                ...
                <div class="col-lg-6 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Daftar Akun Supplier</h2><hr>
                        <?= $this->session->flashdata('pesan'); ?>
                        <?= $this->session->flashdata('error'); ?>
                        <?= form_open('welcome/proses_daftar'); ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Masukkan Nama Anda" name="nama" value="<?= $this->session->flashdata('nama') ?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Masukkan No. Telp" name="no_telp" value="<?= $this->session->flashdata('no_telp') ?>">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" type="password" placeholder="Masukkan Password" name="password" value="<?= $this->session->flashdata('password') ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 text-center">
                                    Sudah punya akun? <a href="<?= site_url('login') ?>" class="text-danger">Login Sekarang!</a>
                                </div>
                            </div>
                        <?= form_close(); ?>
                    </div>
