            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-6 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Login untuk dapat masuk kehalaman tagihan</p>
                        ...
                        <?= form_open('welcome/login'); ?>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <span style="font-size:0.7em" class="pull-left"><a href="<?= site_url('lupa-password') ?>" class="text-danger">Lupa Password Anda?</a></span>
                                    <hr>
                                </div>
                                <div class="col-lg-12 text-center">
